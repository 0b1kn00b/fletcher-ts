...
export declare function Arrow(): typeof ArrowCls;
/**
 ...
 * @memberof Fletcher
 */
export declare function Anon<Pi, Ri>(fn: (p: Pi, cont: JunctionCls<Ri>) => Work.Work): Arrowlet<Pi, Ri>;
/**
 ...
 * @memberof Fletcher
 */
export declare function Event<R extends Event>(self: string): Arrowlet<EventTarget, R>;
/**
 ...
 * @memberof Fletcher
 */
export declare function FlatMap<Pi, Ri, Rii>(fn: (p: Ri) => Arrowlet<Pi, Rii>): ArrowCls<Pi, Ri, Pi, Rii>;
/**
...
export declare function Next<Pi, Pii, Piii, Ri, Rii, Riii>(lhs: ArrowCls<Pi, Pii, Ri, Rii>, rhs: ArrowCls<Ri, Rii, Piii, Riii>): ArrowCls<Pi, Pii, Piii, Riii>;
export declare function React<R>(dispatch: Dispatch<R>): Arrowlet<R, void>;
 ...
 * @memberof Fletcher
 */
export declare function Option<P, R>(self: Arrowlet<P, R>): Arrowlet<O.Option<P>, O.Option<R>>;
/**
 ...
 * @memberof Fletcher
 */
export declare function Timeout<P, R, E>(self: Arrowlet<P, R>, ms: number, error: E): Arrowlet<P, E.Either<E, R>>;
/**
 ...
 * @memberof Fletcher
 */
export declare function Worker<P>(work: Work.Work): Arrowlet<P, P>;
/**
...
* @memberof Fletcher
*/
export declare function RaceWithTimeout<P, R, E>(l: Arrowlet<P, R>, r: Arrowlet<P, R>, ms: any, error: E): Arrowlet<P, E.Either<E, R>>;
/**
 ...
 * @memberof Fletcher
 */
export declare function Map<Pi, R, Ri>(l: Arrowlet<Pi, R>, fn: (r: R) => Ri): Arrowlet<Pi, Ri>;
export declare function Mapi<Pi, Pii, R>(self: Arrowlet<Pii, R>, fn: (pi: Pi) => Pii): Arrowlet<Pi, R>;
export declare function Effect<Pi, R>(self: Arrowlet<Pi, R>): (pi: Pi) => EffectNms.Effect<R, any, Pi>;
export declare function Loop<Pi, R>(self: Arrowlet<Pi, Either.Either<R, Pi>>): Arrowlet<Pi, R>;
export declare function Callback<P, R>(fn: (p: P, cb: (r: R) => void) => void): CallbackCls<P, R>;
